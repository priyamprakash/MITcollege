...
//-------------------------------------------------------------------------------------------
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            story_photo = itemView.findViewById(R.id.story_photo);//pic
            story_username = itemView.findViewById(R.id.story_username);//username
